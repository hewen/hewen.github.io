...
<embed src="http://player.youku.com/player.php/sid/XMTYyNTM0OTg4/v.swf" allowFullScreen="true" quality="high" width="100%" height="100%" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash"></embed>
html常用代码
=============
{% highlight html %}
html:xs,html:5
