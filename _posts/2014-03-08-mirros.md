...
####开源中国镜像站: 
* [http://mirrors.oschina.net/](http://mirrors.oschina.net/)(里面镜像不多,不过有maven的镜像http://maven.oschina.net/content/groups/public/,详细使用看[oschina的maven帮助](http://maven.oschina.net/help.html).)
